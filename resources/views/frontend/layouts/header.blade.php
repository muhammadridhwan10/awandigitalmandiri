        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-2 col-md-2 col-12">
                    <!-- Logo -->
                    <div class="logo" style="max-height: 90px; max-width: 90px;">
                        @php
                            $settings=DB::table('settings')->get();
                        @endphp                    
                    ...
                    <div class="cart-top">
                        ...
                        <a href="{{ route('wishlist') }}" class="mobile-icon">
                            <i class="fa fa-heart-o"></i>
                            <span class="total-count">{{ Helper::wishlistCount() }}</span>
                        </a>

                        <a href="{{ route('cart') }}" class="mobile-icon">
                            <i class="ti-bag"></i>
                    ...
                    <div class="search-bar-top">
                        <div class="search-bar">
                            ...
                            <form method="POST" action="{{route('product.search')}}">
                                ...
                                <button class="btnn" style="background:#004aad" type="submit"><i class="ti-search"></i></button>
                            </form>
                        </div>
                    </div>
                </div>
