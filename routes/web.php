...
// Frontend Routes
    ...
    Route::get('/term-and-conditions', [FrontendController::class, 'termandcondition'])->name('tnm');
...
// Payment
    ...
    Route::get('/payment/status/ipaymu', [OrderController::class, 'paymentSuccess'])->name('payment.status.ipaymu');
    Route::post('/payment/doku/callback', [OrderController::class, 'success'])->name('order.success');
